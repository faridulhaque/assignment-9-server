...
CREATE TABLE "claim_user" (
    ...
    CONSTRAINT "claim_user_pkey" PRIMARY KEY ("claimId","userId")
);
...
-- AddForeignKey
ALTER TABLE "claim_user" ADD CONSTRAINT "claim_user_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "claim_user" ADD CONSTRAINT "claim_user_claimId_fkey" FOREIGN KEY ("claimId") REFERENCES "claims"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
